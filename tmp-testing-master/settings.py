...
sys.path.append(os.path.dirname(f'{os.getcwd()}/socket_testing/otree_extension/'))
...
SESSION_CONFIGS = [
    ...
    dict(
        name='trust_niklas', app_sequence=['trust_niklas', 'payment_info'], num_demo_participants=2
    )
]
